...
filelist = 'val_list.txt'
src_folder = 'results_jhmdb/'
...
for cnt, line in enumerate(f):
    ...
    lblpath = os.path.join('/dataset/dai212', rows[0]) #+ '/joint_positions.mat'
    ...
    imgpath = os.path.join('/dataset/dai212', rows[1]) + '/00001.png'
